...
async def pay_with_balance_handler(callback: CallbackQuery, state: FSMContext):
    ...
    from database.requests import (
        ...
        create_pending_order, complete_order, update_payment_key_id,
    )
    ...
    async with user_locks[user_internal_id]:
        ...
        (_, order_id) = create_pending_order(
            user_id=user_internal_id, tariff_id=tariff_id,
        ...
        try:
            ...
            logger.exception('Ошибка выдачи ключа после списания баланса, order=%s', order_id)
